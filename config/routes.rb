Rails.application.routes.draw do
  ...
  authenticated :user do
    root 'unlok_air#index', as: :authenticated_root
  end
  ...
  get '/unlok_air/:id/bookings/new' => 'bookings#new', as: 'new_booking'
  get '/unlok_air/:id/bookings/create' => 'bookings#create', as: 'create_booking'
